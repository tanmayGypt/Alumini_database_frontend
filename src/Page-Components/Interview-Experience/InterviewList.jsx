...
//     setCurrentIndex((prevIndex) => (prevIndex > 0 ? prevIndex - 1 : interviews.length - 1));
//   };

//   const handleNextClick = () => {
//     setCurrentIndex((prevIndex) => (prevIndex < interviews.length - 1 ? prevIndex + 1 : 0));
//   };
...
//           &#8249;
//         </button>
//         <div className="flex transition-transform duration-500" style={{ transform: `translateX(-${currentIndex * cardWidthPercentage}%)`, width: `${100 * interviews.length}%` }}>
//           {interviews?.map((interview, index) => (
//             <div key={index} className="flex-shrink-0 p-5" style={{ width: `${cardWidthPercentage}%` }}>
//               <Link to={`/interview/${interview.id}`} className="no-underline p-3">
...
//                     postedYear={interview.postedYear}
//                     role={interview.role}
