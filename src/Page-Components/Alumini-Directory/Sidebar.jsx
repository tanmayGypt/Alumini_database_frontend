...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <div ref={sidebarRef} className={`fixed top-16 inset-y-0 left-0 z-30 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
